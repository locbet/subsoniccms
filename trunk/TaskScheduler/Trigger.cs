...
//			base.SyncTrigger();
	...
	/// <summary>
	/// A strong typed collection of Triggers
	/// </summary>
	public class TriggerCollection : CollectionBase
	{
		/// <summary>
		...
		/// <summary>
		/// Loads a read-only collection of 
		/// </summary>
		/// <param name="tl"></param>
		/// <returns></returns>
		public TriggerCollection Load(TriggerList tl)
		{
			foreach (Trigger t in tl)
			{
				List.Add(t);
			}
			return (TriggerCollection)List;
		}
		...
		/// <returns></returns>
		public int Add(Trigger item)
		{
			int rtn = List.Add(item);
			item.Unbind();
			return rtn;
		}
		...
		/// </summary>
		/// <param name="item"></param>
		public void Remove(Trigger item)
		{
			List.Remove(item);
		}

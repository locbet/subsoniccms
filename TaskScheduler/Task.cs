...
namespace TaskScheduler {
	...
	/// New instances are generated by a <see cref="ScheduledTaskController"/> object using Open or Create methods.
	...
	public class Task : IDisposable {
		...
		#region Constructors
		/// <summary>
		/// Internal constructor for a task, used by <see cref="ScheduledTaskController"/>.
		/// </summary>
